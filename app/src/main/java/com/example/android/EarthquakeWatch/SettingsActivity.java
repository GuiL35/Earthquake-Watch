    ...
    public static class EarthquakePreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener{
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            /* Update the preference summary when the settings activity is launched.
               Given the key of a preference, use PreferenceFragment's findPreference() method to
        ...
        /**
         * Set the current EarhtquakePreferenceFragment instance as the listener on each preference.
